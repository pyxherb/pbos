...
PBOS_NORETURN void hali_debug_isr();	// 0x01 Debug
...
PBOS_NORETURN void hali_debug_nmi();	// 0x02 NMI
void hali_nmi_isr_impl();

PBOS_NORETURN void hali_breakpoint_isr(); // 0x03 Breakpoint
...
PBOS_NORETURN void hali_fpu_segment_overrun_isr();  // 0x09 x87 Segment Overrun
