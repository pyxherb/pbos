...
void initcar_init() {
	...
	if(KM_FAILED(mm_mmap(mm_kernel_context, initcar_ptr, ARCH_KARGS_PTR->initcar_ptr, ARCH_KARGS_PTR->initcar_size, MM_PAGE_MAPPED | MM_PAGE_READ, 0)))
		km_panic("Error mapping INITCAR");
