...
typedef struct _fs_dir_t : public fs_fnode_t {
	kfxx::hash_map_t<kfxx::string_view, fs::fnode_ptr_t> children_map;
...
PBOS_NODISCARD km_result_t kn_do_rename_fnode(fs_fnode_t *file_node, const char *name, size_t name_len);
