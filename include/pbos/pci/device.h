...
enum {
	PCI_DEVICE_HEADER_TYPE_GENERAL = 0x00,
	PCI_DEVICE_HEADER_TYPE_PCI_TO_PCI_BRIDGE = 0x01,
	PCI_DEVICE_HEADER_TYPE_PCI_TO_CARDBUS_BRIDGE = 0x02,
};

enum {
	PCI_COMMAND_IO_SPACE = 0x0001,
	PCI_COMMAND_MEMORY_BUS = 0x0002,
	...
	PCI_COMMAND_FAST_BACK_TO_BACK_ENABLE = 0x0200,
	PCI_COMMAND_INTERRUPT_DISABLE = 0x0400,
};

enum {
	PCI_STATUS_INTERRUPT_STATUS = (1 << 3),
	PCI_STATUS_CAPABILITIES_LIST = (1 << 4),
	PCI_STATUS_66MHZ_CAPABLE = (1 << 5),
	PCI_STATUS_FAST_BACK_TO_BACK_CAPABLE = (1 << 7),
	PCI_STATUS_MASTER_DATA_PARITY_ERROR = (1 << 8),
	PCI_STATUS_DEVSEL_TIMING_MASK = (0b11 << 9),
	PCI_STATUS_SIGNALED_TARGET_ABORT = (1 << 11),
	PCI_STATUS_RECEIVED_TARGET_ABORT = (1 << 12),
	PCI_STATUS_RECEIVED_MASTER_ABORT = (1 << 13),
	PCI_STATUS_SIGNALED_SYSTEM_ERROR = (1 << 14),
	PCI_STATUS_DETECTED_PARITY_ERROR = (1 << 15),
};

enum {
	PCI_DEVSEL_TIMING_FAST = 0b00,
	PCI_DEVSEL_TIMING_MEDIUM = 0b01,
	PCI_DEVSEL_TIMING_SLOW = 0b10,
};
...
enum {
	...
	PCI_CLASS_CODE_MEMORY_CONTROLLER = 0x05,
	...
	PCI_CLASS_CODE_SYSTEM_PERIPH = 0x08,
	/// @brief PCI class class code for input device controllers.
	PCI_CLASS_CODE_INPUT = 0x09,
	...
	PCI_CLASS_CODE_SIGNAL_PROCESSING = 0x11,
	/// @brief PCI class class code for processing accelerator.
	PCI_CLASS_CODE_PROCESSING_ACCEL = 0x12,
...
enum {
	...
	PCI_PROG_IF_IPMI_KEYBOARD = 0x01,
