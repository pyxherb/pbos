...
static void kf_rbtree_lrot(kf_rbtree *tree, kf_rbtree_node_t *x);
static void kf_rbtree_rrot(kf_rbtree *tree, kf_rbtree_node_t *x);
static void kf_rbtree_insert_fixup(kf_rbtree *tree, kf_rbtree_node_t *node);
static kf_rbtree_node_t *kf_rbtree_remove_fixup(kf_rbtree *tree, kf_rbtree_node_t *node);
static void kf_rbtree_walk_nodes_for_freeing(kf_rbtree *tree, kf_rbtree_node_t *node);

void kf_rbtree_init(kf_rbtree *dest,
...
km_result_t kf_rbtree_insert(kf_rbtree *tree, kf_rbtree_node_t *node) {
	kd_assert(!node->l);
	kd_assert(!node->r);
...
void kf_rbtree_remove(kf_rbtree *tree, kf_rbtree_node_t *node) {
...
kf_rbtree_node_t *kf_rbtree_find(kf_rbtree *tree, kf_rbtree_node_t *node) {
...
kf_rbtree_node_t **kf_rbtree_find_slot(kf_rbtree *tree, kf_rbtree_node_t *node, kf_rbtree_node_t **p_out) {
	kf_rbtree_node_t **i = &tree->root;
	*p_out = NULL;
...
kf_rbtree_node_t *kf_rbtree_find_max_lteq_node(kf_rbtree *tree, kf_rbtree_node_t *node) {
...
void kf_rbtree_free(kf_rbtree *tree) {
	if (tree->root)
