...
// Kernel PTT
//
#define KPTT_VBASE (KTMPMAP_VTOP + 1)
#define KPTT_SIZE 0x00400000
#define KPTT_VTOP (KPTT_VBASE + KPTT_SIZE - 1)
...
#define CRITICAL_SIZE ((INIT_CRITICAL_SIZE) + (KPTT_SIZE) + (KTMPMAP_SIZE) + (KTOPPGTAB_SIZE) + (KCTXTSWTMP_SIZE))
