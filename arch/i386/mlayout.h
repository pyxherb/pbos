...
//
#define INIT_CRITICAL_PBASE KERNEL_PBASE
#define INIT_CRITICAL_VBASE KERNEL_VBASE
...
// Critical Area
//
#define CRITICAL_PBASE INIT_CRITICAL_PBASE
#define CRITICAL_VBASE INIT_CRITICAL_VBASE
...
#define KRESERVED_VBASE (KERNEL_VBASE)
...
//
#define KALLPGTAB_VTOP (KSPACE_VTOP)
#define KALLPGTAB_SIZE 0x00400000
#define KALLPGTAB_VBASE ((KSPACE_VTOP - KALLPGTAB_SIZE) + 1)

//
// Kernel Top Area
//
#define KTOP_VBASE KALLPGTAB_VBASE
#define KTOP_VTOP KSPACE_VTOP
#define KTOP_SIZE (KTOP_SIZE - KTOP_VBASE + 1)
