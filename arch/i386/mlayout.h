...
#define KTMPMAP_VTOP (KTMPMAP_VBASE + KTMPMAP_SIZE)
...
#define KPRIVMAP_VTOP (KPRIVMAP_VBASE + KPRIVMAP_SIZE)
...
#define CRITICAL_SIZE ((INIT_CRITICAL_SIZE) + (KTMPMAP_SIZE) + (KPRIVMAP_SIZE))
