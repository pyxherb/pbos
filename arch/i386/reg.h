...
///
FORCEINLINE static uint32_t arch_rcr0() {
	uint32_t value;
...
///
FORCEINLINE static void arch_wcr0(uint32_t value) {
...
///
FORCEINLINE static uint32_t arch_rcr2() {
	uint32_t value;
...
/// @param value The value to write.
///
FORCEINLINE static void arch_wcr2(uint32_t value) {
...
///
FORCEINLINE static uint32_t arch_rcr3() {
	uint32_t value;
...
/// @param value The value to write.
///
FORCEINLINE static void arch_wcr3(uint32_t value) {
...
///
FORCEINLINE static uint32_t arch_rcr4() {
	uint32_t value;
...
/// @param value The value to write.
///
FORCEINLINE static void arch_wcr4(uint32_t value) {
...
///
FORCEINLINE static uint32_t arch_rflags() {
	uint32_t eflags;
...
/// @param value The value to write.
///
FORCEINLINE static void arch_wflags(uint32_t eflags) {
