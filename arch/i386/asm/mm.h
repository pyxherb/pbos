...
//
// Kernel Private Mapping Area
//
#define KPRIVMAP_VBASE (KTMPMAP_VTOP + 1)
#define KPRIVMAP_SIZE 0x00100000
#define KPRIVMAP_VTOP (KPRIVMAP_VBASE + KPRIVMAP_SIZE - 1)

//
// Context switching temporary data
//
#define KCTXTSWTMP_VBASE (KPRIVMAP_VTOP + 1)
...
#define CRITICAL_SIZE ((INIT_CRITICAL_SIZE) + (KTMPMAP_SIZE) + (KPRIVMAP_SIZE) + (KCTXTSWTMP_SIZE))
