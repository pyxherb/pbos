#ifndef _ARCH_X86_64_ASM_MM_H_
#define _ARCH_X86_64_ASM_MM_H_
...
//
// Kernel space that maps all page tables
//
#define KALLPGTAB_VBASE 0x80000000
#define KALLPGTAB_SIZE 0x00400000
#define KALLPGTAB_VTOP (KALLPGTAB_VBASE + KALLPGTAB_SIZE - 1)

//
// Kernel Image
//
#define KERNEL_PBASE 0x02000000
#define KERNEL_VBASE (KALLPGTAB_VTOP + 1)
...
//
#define KTOPPGTAB_VBASE (KINITTMPMAP_VTOP + 1)
...
#define CRITICAL_SIZE ((INIT_CRITICAL_SIZE) + (KINITTMPMAP_SIZE) + (KTOPPGTAB_SIZE))
#define CRITICAL_PTOP (CRITICAL_PBASE + CRITICAL_SIZE - 1)
#define CRITICAL_VTOP (CRITICAL_VBASE + CRITICAL_SIZE - 1)

#define KRESERVED_VBASE (KALLPGTAB_VTOP + 1)
#define KRESERVED_SIZE (CRITICAL_SIZE + KALLPGTAB_SIZE)
#define KRESERVED_VTOP (KRESERVED_VBASE + KRESERVED_SIZE - 1)
