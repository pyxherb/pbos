#ifndef _ARCH_X86_64_REG_H_
#define _ARCH_X86_64_REG_H_
...
///
PBOS_FORCEINLINE static uint64_t arch_rcr0() {
	uint64_t value;
...
///
PBOS_FORCEINLINE static void arch_wcr0(uint64_t value) {
...
///
PBOS_FORCEINLINE static uint64_t arch_rcr2() {
	uint64_t value;
...
/// @param value The value to write.
///
PBOS_FORCEINLINE static void arch_wcr2(uint64_t value) {
	__asm__ __volatile__("movq %0,%%cr2" ::"r"(value));
}
...
///
PBOS_FORCEINLINE static uint64_t arch_rcr3() {
	uint64_t value;
...
/// @param value The value to write.
///
PBOS_FORCEINLINE static void arch_wcr3(uint64_t value) {
	__asm__ __volatile__("movq %0,%%cr3" ::"r"(value));
}
...
///
PBOS_FORCEINLINE static uint64_t arch_rcr4() {
	uint64_t value;
...
/// @param value The value to write.
///
PBOS_FORCEINLINE static void arch_wcr4(uint64_t value) {
	__asm__ __volatile__("movq %0,%%cr4" ::"r"(value));
}
...
///
PBOS_FORCEINLINE static uint64_t arch_rflags() {
	uint64_t eflags;
...
/// @param value The value to write.
///
PBOS_FORCEINLINE static void arch_wflags(uint64_t eflags) {
	__asm__ __volatile__("pushq %0" ::"r"(eflags));
	__asm__ __volatile__("popfq");
}

///
/// @brief Get value of RIP register.
///
/// @return Value of RIP register.
///
void* arch_rrip();
