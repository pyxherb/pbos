#ifndef _ARCH_X86_64_SEG_H_
#define _ARCH_X86_64_SEG_H_
...
PBOS_FORCEINLINE static void arch_lgdt(void *gdt, uint16_t desc_num) {
...
void arch_loadcs(uint16_t value);
...
PBOS_FORCEINLINE static uint16_t arch_storefs() {
	uint16_t value;
